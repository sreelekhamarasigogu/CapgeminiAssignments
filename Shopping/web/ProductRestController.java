...
import com.cap.Shopping.exception.InvalidCategoryException;
import com.cap.Shopping.exception.InvalidCostRangeException;
import com.cap.Shopping.service.ProductService;
...
public class ProductRestController {
	...
	@ApiOperation(value = "product post mapping" , response = Prodcuct.class)
	@PostMapping("/product")
	public Prodcuct insertProduct(@RequestBody @Valid Prodcuct product) {
	...
	@PutMapping("/update")
	public Prodcuct updateProduct(@RequestBody Prodcuct product) {
	...
	public List<Prodcuct> getAllProductsByCategory(@PathVariable String category) throws InvalidCategoryException {
		int flag = 0;
	...
	public List<Prodcuct> getAllProductsByCategoryAndPrice(@PathVariable String category, @PathVariable int range1,@PathVariable int range2) throws InvalidCostRangeException {
